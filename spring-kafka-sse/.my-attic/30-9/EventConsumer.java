...
import bringg.kafka.stream.configurations.SingleSinkProcessor;
...
public class EventConsumer {
    ...
    void countTasksAssignedToActiveDriver(@Input("tasks") KStream<Object, Task> tasks,
                                          //@Input("shifts") KTable<Object, ShiftWrapper> shifts) {
                                          @Input("shifts") KStream<Object, ShiftWrapper> shifts) {

//        KStream<String, ShiftWrapper> mappedShiftStream =
...
//                        ,Materialized.<String, List<ShiftWrapper>, WindowStore<Bytes, byte[]>>as("result-store")
...
//                        Materialized.<String, List<ShiftWrapper>, SessionStore<Bytes, byte[]>>
