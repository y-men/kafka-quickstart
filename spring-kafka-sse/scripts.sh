...
kafka-console-consumer --bootstrap-server 127.0.0.1:9092 --topic drivers-on-shift --from-beginning  --formatter kafka.tools.DefaultMessageFormatter  --property print.key=true \
